...
public class Endscreen extends JLabel implements ActionListener {
	...
	int coins, bullets,score;

	// Constructor
	Endscreen(Window k, int coins, int bullets,int Score) {
	...
	public static void playSound(String filePath) {
        try {
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(
                    Endscreen.class.getResource(filePath));
